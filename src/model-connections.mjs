...
export const MODEL_PRESETS = [
  ...
  { id:'qwen3-coder-flash', name:'Qwen3 Coder Flash', provider:'蚂蚁 MaaS', capabilities:['text','code'] },
  ...
  { id:'wan2.7-videoedit', name:'万相 2.7 视频编辑', provider:'蚂蚁 MaaS', capabilities:['video'] },
  { id:'wan3.0-video', name:'万相 3.0 视频生成', provider:'蚂蚁 MaaS', capabilities:['video'] },
  { id:'wan2.6-t2i', name:'万相 2.6 文生图', provider:'蚂蚁 MaaS', capabilities:['image_generate'] },
  { id:'wan2.7-image', name:'万相 2.7 图像生成', provider:'蚂蚁 MaaS', capabilities:['image_generate'] },
